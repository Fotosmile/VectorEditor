...
void EventManager::subscribe(EventManager::EventType eventType, std::unique_ptr<Subscriber> subscriber)
{
    m_subscribers.insert(std::make_pair(eventType, std::move(subscriber)));
}

void EventManager::unsubscribe(EventManager::EventType eventType, std::unique_ptr<Subscriber> subscriber)
{
...
void EventManager::notifySubscribers(EventManager::EventType eventType, GUIState::StateType stateType)
{
